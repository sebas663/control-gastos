...
public class MasterBoxDiscountService extends CRUDService<MasterBoxDiscount, MasterBoxDiscountDTO, Integer> implements IMasterBoxDiscountService{
	
	@Autowired
	private static IMasterBoxDiscountRepository masterBoxDiscountRepository;
}
